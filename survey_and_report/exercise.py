...
class Question_4:
    ...
    def get_answer(self):
        if (
            self.answer_pr > self.ANSWER_120 and self.answer_cur == self.ANSWER_EUR or
            self.answer_pr > self.ANSWER_265 and self.answer_cur == self.ANSWER_USD
        ):
            ...
            self.answer_pr < self.ANSWER_60  and self.answer_cur == self.ANSWER_EUR or
            self.answer_pr < self.ANSWER_132 and self.answer_cur == self.ANSWER_USD
        ):
