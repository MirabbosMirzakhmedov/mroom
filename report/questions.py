...
class Question_4:
    ...
    def get_answer(self):
        if (
            ...
            return Text().get_some_text(calculation_1=calculation_1)
            # return "Lorem ipsum dolor sit amet, consectetur adipiscing elit." \
            ...
            return Text().get_some_text_two(calculation_2=calculation_2)
            # return "Lorem ipsum dolor sit amet, consectetur adipiscing elit." \
            ...
            return Text().get_some_text_three(calculation_3=calculation_3)
