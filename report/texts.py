...
class Text:
    ...
    ANSWER_SHORT = "Lorem ipsum 1. Question - ANSWER_2 dolor sit amet," \
    ...
    ANSWER_MEDIUM = "Sed vel bibendum tortor. Proin a aliquet tortor." \
    ...
    ANSWER_LONG = "Mauris urna nunc, eleifend id sapien eget, tincidunt" \
    ...
    ANSWER_EVERDAY_AND_ANSWER_2_TIMES = "Mauris urna nunc, eleifend id" \
    ...
    ANSWER_1_TIME_AND_ANSWER_3_TIMES = "In nisl ligula, porttitor vel lobortis" \
    ...
    ANSWER_YES_aloe_not_washing = \
        "Fusce sem est, maximus ac efficitur in, accumsan eu" \
